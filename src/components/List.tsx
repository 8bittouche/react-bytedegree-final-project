...
const Books: React.FC<BooksProps> = ({ books, loading, goAdd, logout, getBookList, removeBookById, setBookId }) => {
        ...
        columns={[
          {
            ...
            key: 'book',
            render: (text, record) => (
              <Book {...record} key={record.bookId} removeBookById={removeBookById} setBookId={setBookId} />
            ),
          },
        ]}
